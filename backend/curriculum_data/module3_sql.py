    ...
    "supplementary_courses": [
        {
            ...
            "syllabus": [
                {"module": "1. Getting Started with SQL", "topics": "Intro to databases, SELECT, INSERT, UPDATE, DELETE, WHERE, COUNT, DISTINCT, LIMIT"},
                {"module": "2. Intro to Relational Databases and Tables", "topics": "Relational DB concepts, DDL vs DML, CREATE TABLE, ALTER, DROP, TRUNCATE, creating cloud DB instances"},
                {"module": "3. Intermediate SQL", "topics": "String patterns (LIKE), sorting (ORDER BY), grouping (GROUP BY), built-in functions, date/time functions, sub-queries, multi-table queries"},
                {"module": "4. Accessing Databases using Python", "topics": "Python DB-API, SQL magic in Jupyter, SQLite, analyzing real-world datasets with Python + SQL"},
                {"module": "5. Course Assignment", "topics": "Real-world Chicago datasets, final exam, hands-on querying project"},
                {"module": "6. Bonus: Advanced SQL for Data Engineers", "topics": "Views, stored procedures, ACID transactions, INNER/OUTER JOINs"},
            ],
